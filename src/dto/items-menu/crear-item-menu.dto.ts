import { IsString, IsNotEmpty, MaxLength, IsOptional, IsUrl, IsInt, Min, IsBoolean, IsUUID, IsNumber, IsArray, Max } from 'class-validator';
import { Transform } from 'class-transformer';

export class CrearItemMenuDto {
