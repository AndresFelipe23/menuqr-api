import { IsString, IsOptional, MaxLength, IsEmail, IsBoolean, IsDecimal, Matches, Length } from 'class-validator';
...
export class ActualizarRestauranteDto {
  ...
  @IsString({ message: 'El estado de suscripción debe ser una cadena de texto' })
  @IsOptional()
  @MaxLength(20, { message: 'El estado de suscripción no puede exceder 20 caracteres' })
